  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: "32px" }}>
        ...
        >
          Assemble an undeniable, high-converting career narrative today.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          ...
          <input
            ...
            style={{
              ...
              border: focusedField === "name" ? "1px solid #f97316" : "1px solid rgba(255, 255, 255, 0.08)",
              borderRadius: "10px",
              padding: "12px 16px",
              color: "#fff",
              fontSize: "14px",
              ...
              fontFamily: "'Plus Jakarta Sans', sans-serif",
              transition: "all 0.2s",
              boxShadow: focusedField === "name" ? "0 0 12px rgba(249, 115, 22, 0.2)" : "none",
            }}
          />
        </div>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: "10px", marginTop: "4px" }}>
          ...
          />
          <label htmlFor="agree" style={{ fontSize: "12px", color: "rgba(255,255,255,0.45)", lineHeight: 1.4, cursor: "pointer" }}>
            I agree to the{" "}
            <a href="#" style={{ color: "#fb923c", textDecoration: "none" }} onMouseEnter={(e) => (e.target.style.textDecoration = "underline")} onMouseLeave={(e) => (e.target.style.textDecoration = "none")}>
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="#" style={{ color: "#fb923c", textDecoration: "none" }} onMouseEnter={(e) => (e.target.style.textDecoration = "underline")} onMouseLeave={(e) => (e.target.style.textDecoration = "none")}>
